...
$path = $_SERVER['DOCUMENT_ROOT'] . '/poliklinik_bengkel_koding/config/koneksi.php';
require $path;
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                // Ubah query untuk join dengan tabel poli
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data['nama_poli']; ?></td> <!-- Tampilkan nama poli -->
                                    <td>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="/poliklinik_bengkel_koding/pages/dokterProfile/updateProfile.php" method="post">
